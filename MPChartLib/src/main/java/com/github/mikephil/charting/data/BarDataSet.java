...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    boolean isHighlightFullBar = false;

    /**
     * 高度是否充满
     * @param isHighlightFullBar
     */
    public void setHighlightFullBar(boolean isHighlightFullBar) {
        this.isHighlightFullBar = isHighlightFullBar;
    }
    @Override
    public boolean isHighlightFullBar() {
        return isHighlightFullBar;
    }
}
