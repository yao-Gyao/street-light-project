...
//        mShift = Utils.convertDpToPixel(12f);
    ...
    @Override
    public List<Integer> getValueLineColors() {
        return mValueLineColors;
    }

    public void setValueLineColors(List<Integer> valueLineColors) {
        this.mValueLineColors = valueLineColors;
    }
