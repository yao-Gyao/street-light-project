...
//            }
            LinearGradient lg = new LinearGradient(0, buffer.buffer[j + 1], 0, buffer.buffer[j + 3], dataSet.getColor(0), dataSet.getColor(1), Shader.TileMode.CLAMP);
...
//            mHighlightPaint.setAlpha(set.getHighLightAlpha());
            ...
            if (isStack) {
                ...
                if (set.isHighlightFullBar()) {
                    y1 = mViewPortHandler.contentTop() + mViewPortHandler.contentBottom();
                    y2 = 0.f;
                } else {
                    y1 = e.getY();
                    y2 = 0.f;
