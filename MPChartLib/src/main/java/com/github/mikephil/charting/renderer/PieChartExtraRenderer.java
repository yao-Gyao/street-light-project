...
import com.github.mikephil.charting.charts.PieChartExtra;
...
public class PieChartExtraRenderer extends DataRenderer {

    protected PieChartExtra mChart;
    ...
    public PieChartExtraRenderer(PieChartExtra chart, ChartAnimator animator,
    ...
    private static float mLineRotate;
     ...
     * @param rotate
     */
    public static void setRotateLine(float rotate) {
        mLineRotate = rotate;
    }
    ...
    public void drawValues(Canvas c) {
        ...
        //修改角度
        float[] drawAngles = {mLineRotate};
        float[] absoluteAngles = {mLineRotate};
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0; j < entryCount; j++) {
                if (dataSet.getValueLineColors() != null && !dataSet.getValueLineColors().isEmpty()) {
                    mValueLinePaint.setColor(dataSet.getValueLineColors().get(j % dataSet.getValueLineColors().size()));
                } else {
