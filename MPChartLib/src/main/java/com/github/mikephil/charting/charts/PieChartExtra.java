...
import com.github.mikephil.charting.renderer.PieChartExtraRenderer;
 ...
 * 饼状图(可添加额外的指示线)
 */
public class PieChartExtra extends PieRadarChartBase<PieData> {
    ...
    /**
     * if true, 图表中的白洞将被绘制出来
     */
    private boolean mDrawHole = true;

    /**
     * if true,这个洞可以透视到切片的内部
     */
    private boolean mDrawSlicesUnderHole = false;

    /**
     * if true, 图中的值被绘制成百分比值
     */
    ...
    public PieChartExtra(Context context) {
        super(context);
    }

    public PieChartExtra(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieChartExtra(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new PieChartExtraRenderer(this, mAnimator, mViewPortHandler);
        mXAxis = null;
    ...
    /**
     * 返回所有不同角度的整数数组，图表切片返回的数组中的角度决定了多少空间(360)
     * each slice takes
     *
     * @return
     */
    ...
    public void setHoleColor(int color) {
        ((PieChartExtraRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((PieChartExtraRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieChartExtraRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((PieChartExtraRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((PieChartExtraRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((PieChartExtraRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((PieChartExtraRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((PieChartExtraRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((PieChartExtraRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((PieChartExtraRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof PieChartExtraRenderer) {
            ((PieChartExtraRenderer) mRenderer).releaseBitmap();
        }
